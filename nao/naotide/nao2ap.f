c$main
      program naotest
c
c Test driver program for subroutine <naotide>
c
...
c
c Station location
      x       = 125.15000d0     ! East longitude in degree
      y       =   1.60000d0     ! North latitude in degree
c
c Start epoch
      iyear1  = 2019 ! year
      imon1   =    6 ! month
...
c
      data omapdir /'./omap'/
c     data omapdir /'/home/thinkstation/sources/nao/omap'/
c
c ***************************
c     
      save
