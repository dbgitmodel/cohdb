...
!  ---open output file
   IF (.NOT.cold_start.AND.master) THEN
      ...
      WRITE (iunit,'(A)') 'Output parameters for test case obcest: simulation '&
                        & //TRIM(runtitle)
      WRITE (iunit,*)
   ENDIF
!  ---output frequency
...
!  ---evaluate
   CALL usrdef_tsr0d_vals(out0ddat,15)

!  ---write
   IF (master) THEN
      WRITE (iunit,9001) ihour
      WRITE (iunit,9002) 'd30max', out0ddat(1)
      WRITE (iunit,9002) 'dist30', out0ddat(2)
      WRITE (iunit,9002) 'd18max', out0ddat(3)
      WRITE (iunit,9002) 'dist18', out0ddat(4)
      WRITE (iunit,9002) 'area30', out0ddat(5)
      WRITE (iunit,9002) 'area15', out0ddat(6)
      WRITE (iunit,9002) 'pdep1', out0ddat(7)
      WRITE (iunit,9002) 'pdep2', out0ddat(8)
      WRITE (iunit,9002) 'pdep3', out0ddat(9)
      WRITE (iunit,9002) 'umax', out0ddat(10)
      WRITE (iunit,9002) 'wmax', out0ddat(11)
      WRITE (iunit,9002) 'wmin', out0ddat(12)
      WRITE (iunit,9002) 'ekin', out0ddat(13)
      WRITE (iunit,9002) 'epot', out0ddat(14)
      WRITE (iunit,9002) 'enstr', out0ddat(15)
   ENDIF
