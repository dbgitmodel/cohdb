...
IF (iopt_sed_mode.EQ.1) THEN
   tsrvars%ivarid = (/iarr_umvel,iarr_vmvel,iarr_zeta,iarr_bdragcoefatc,&
                    & iarr_bstresatc,iarr_bstres_cr,iarr_qbedatu,iarr_qbedatv,&
                    & iarr_waveheight,iarr_waveperiod,iarr_wavedir,&
                    & iarr_wavevel,iarr_waveexcurs/)
ELSEIF (iopt_sed_mode.EQ.4) THEN
   tsrvars%ivarid = (/iarr_umvel,iarr_vmvel,iarr_zeta,iarr_bdragcoefatc,&
                    & iarr_bstresatc,iarr_bstres_cr,iarr_qtotatu,iarr_qtotatv,&
                    & iarr_waveheight,iarr_waveperiod,iarr_wavedir,&
                    & iarr_wavevel,iarr_waveexcurs/)
ENDIF
...
ivarstsr(1,1:13) = (/(ivar,ivar=1,13)/)
...
tsrgpars(1)%xlims = (/1,nc-1,1/)
tsrgpars(1)%ylims = (/1,nr-1,1/)
tsrgpars(1)%tlims = (/2,nstep-1,3/)
