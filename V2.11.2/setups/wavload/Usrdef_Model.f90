...
!    wavloadA: Souslby (1997)
!    wavloadB: Madsen Grant (1976)
!    wavloadC: van Rijn (2003)
!    wavloadD: m/s van Rijn (2007)
!
! Reference -
!
...
CEndDateTime(1:23)   = '2009/04/01;15:00:00:000'
...
modfiles(io_inicon,ics_phys,1)%tlims = (/0,int_fill,270/)
!---wave input
modfiles(io_wavsur,1,1)%status = 'N'
modfiles(io_wavsur,1,1)%tlims = (/0,int_fill,-3/)
...
! Version - @(COHERENS)Usrdef_Model.f90  V2.0
!
! Last update - 4 Nov 2008  @(COHERENS)Usrdef_Model.f90  V2
!
! Description -
!
! Reference -
...
SUBROUTINE usrdef_1dsur_data(ciodatetime,surdata)
!************************************************************************
!
...
! Reference -
!
! Calling program - define_1dobc_data
!
!************************************************************************
!
USE syspars
...
REAL, INTENT(INOUT), DIMENSION(3) :: surdata

!
! Name         Type   Purpose
!------------------------------------------------------------------------------
!*ciodatetime* CHAR   Date/time in data file
!*surdata*     REAL   Data for surface forcing
!                     1 : X-component of surface slope                [m^2/s]
!                     2 : Y-component of surface slope                [m^2/s]
