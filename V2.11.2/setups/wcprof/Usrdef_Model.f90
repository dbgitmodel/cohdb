...
SELECT CASE (runtitle(8:8))
   CASE ('H'); iopt_bstres_waves_bfric = 1
   CASE ('I'); iopt_bstres_waves_bfric = 2
   CASE ('J'); iopt_bstres_waves_bfric = 4
   CASE DEFAULT; iopt_bstres_waves_bfric = 3
END SELECT
...
CStartDateTime = '2009/04/01;00:00:00:000'
CEndDateTime   = '2009/04/01;12:00:00:000'
...
SELECT CASE (runtitle(8:8))
   CASE ('B'); zrough_cst = 0.01
   CASE ('C'); zrough_cst = 0.0001 
   CASE DEFAULT; zrough_cst = 0.001
END SELECT
