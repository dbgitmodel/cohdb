...
IF ((runtitle(7:7).EQ.'B').OR.(runtitle(7:7).EQ.'C')) THEN
   iopt_vdif_coef = 2
ELSE
   iopt_vdif_coef = 3
ENDIF
...
IF (runtitle(7:7).EQ.'B') iopt_turb_alg = 1
IF (runtitle(7:7).EQ.'C') iopt_turb_alg = 3
...
USE modids
USE switches
USE modvars_routines, ONLY : file_suffix
