...
!
!---varids
tsrvars%ivarid = (/iarr_bstresatc,iarr_bottom_sed_flux,iarr_bstres_cr,&
                 & iarr_cref,iarr_uvel,iarr_cvol,iarr_vdiffcoef_sed/)

!---rank
tsrvars%nrank = (/2,2,2,2,3,3,3/)

!---variable number
tsrvars(2:4)%numvar = 1; tsrvars(6:7)%numvar = 1
