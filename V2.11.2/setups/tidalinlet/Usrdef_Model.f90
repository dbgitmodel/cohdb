...
SELECT CASE (runtitle(11:11))
   CASE ('A')
      IF (npworld.EQ.1) iopt_waves = 0
      iopt_waves_couple = 2
   CASE ('B')
      iopt_waves_couple = 1
      iopt_waves_form = 2; iopt_waves_curr = 1
   ...
   CASE ('D')
      iopt_waves_couple = 3
      iopt_waves_form = 1; iopt_waves_curr = 1
      iopt_waves_dissip = 1; iopt_waves_pres = 1
      iopt_bstres_waves_bfric = 1
END SELECT
...
nosetstsr = 2
novarstsr = MERGE(6,22,runtitle(11:11).EQ.'A')
nostatstsr = 10
