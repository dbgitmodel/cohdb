...
SELECT CASE (runtitle(11:11))
   ...
   CASE ('C')
      tsrvars(1:13)%ivarid = (/iarr_deptotatc,iarr_zeta,iarr_umvel,iarr_vmvel,&
        ...
        & iarr_hmbwdissipmag/)
      tsrvars(1:13)%nrank = 2
   END SELECT

IF (iopt_grid_nodim.EQ.3) THEN
   tsrvars(15:21)%ivarid = (/iarr_uvel,iarr_vvel,iarr_wphys,iarr_ustokesatc,&
                           & iarr_vstokesatc,iarr_uveltot,iarr_vveltot/)
   tsrvars(15:21)%nrank = 3
ENDIF
