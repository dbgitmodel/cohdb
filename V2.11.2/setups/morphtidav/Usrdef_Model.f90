...
!************************************************************************
!
! *Usrdef_Model* experiment for testing tidal averaging method
!
...
sflag = MERGE(.TRUE.,.FALSE.,runtitle(11:11).EQ.'0')
...
!---tidal accelaration
IF (sflag.OR.runtitle(12:12).EQ.'A') THEN
    iopt_tidal_accel = 0
ELSE
    iopt_tidal_accel = 1
ENDIF
...
IF (sflag) THEN
    CStartDateTime(1:19) = '2009/03/30;00:00:00'
    CEndDateTime(1:19)   = '2009/04/01;00:00:00'
ELSE
    CStartDateTime(1:19) = '2009/04/01;00:00:00'
    CEndDateTime(1:19)   = '2009/04/05;00:00:00'
ENDIF
...
modfiles(io_inicon,ics_phys,1)%filename = MERGE('          ',&
                                              & 'physics.nc',sflag)
...
IF (sflag) THEN
   ...
   modfiles(io_fincon,ics_phys,2)%filename = 'physics.nc'
...
outtitle = runtitle(1:10)//runtitle(12:12)
