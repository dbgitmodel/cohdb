...
!
!---varids
tsrvars%ivarid = (/iarr_zeta,iarr_umvel,iarr_bstresatc,iarr_bottom_sed_flux,&
                 & iarr_cref,iarr_bstres_cr,iarr_uvel,iarr_vvel,iarr_wphys,&
                 & iarr_dens,iarr_ctot,iarr_cvol,iarr_vdiffcoef_sed/)

!---rank
tsrvars(1:6)%nrank = 2; tsrvars(7:13)%nrank = 3

!---variable number
tsrvars(4:6)%numvar = 1; tsrvars(12:13)%numvar = 1
